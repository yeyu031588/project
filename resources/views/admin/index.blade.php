        ...
        <ul id="menu">
            <li class="menu-list">
               <a style="cursor:pointer" class="firsta"><i  class="glyph-icon xlcd"></i>产品与服务<s class="sz"></s></a>
                <ul>
                    <li><a href="" target="menuFrame"><i class="glyph-icon icon-chevron-right1"></i>企业资料管理</a></li>
                    <li><a href="" target="menuFrame"><i class="glyph-icon icon-chevron-right2"></i>产品管理(石材等)</a></li>
                    <li><a href="" target="menuFrame"><i class="glyph-icon icon-chevron-right3"></i>我的微网站</a></li>
                </ul>
            </li>
            <li class="menu-list">
               <a style="cursor:pointer" class="firsta"><i  class="glyph-icon xlcd"></i>产品与服务<s class="sz"></s></a>
